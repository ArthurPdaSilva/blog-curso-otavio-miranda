...
export async function createLoginSession(username: string) {
  ...
  cookieStore.set(loginCookieName, loginSession, {
    ...
    httpOnly: true,
    // Força o cookie a só ser enviado em conexões https
    secure: true,
    // Define se o cookie pode ser enviado quando a requisição vem de outro site.
    // "strict" = o nível mais rígido.
    // O cookie não é enviado se o usuário vier de outro domínio.
    sameSite: "strict",
    expires: expiresAt,
  });
}
